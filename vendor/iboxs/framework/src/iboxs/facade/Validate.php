 ...
 * @method static void setLang(\iboxs\Lang $lang) 设置Lang对象
 * @method static void setDb(\iboxs\Db $db) 设置Db对象
 * @method static void setRequest(\iboxs\Request $request) 设置Request对象
 * @method static \iboxs\Validate rule(string|array $name, mixed $rule = '') 添加字段验证规则
 * @method static \iboxs\Validate extend(string $type, callable $callback = null, string $message = null) 注册验证（类型）规则
 ...
 * @method static \iboxs\Validate failException(bool $fail = true) 设置验证失败后是否抛出异常
 * @method static \iboxs\Validate only(array $fields) 指定需要验证的字段列表
 * @method static \iboxs\Validate remove(string|array $field, mixed $rule = null) 移除某个字段的验证规则
 * @method static \iboxs\Validate append(string|array $field, mixed $rule = null) 追加某个字段的验证规则
