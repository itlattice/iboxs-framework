...
<div id="iboxs_page_trace_open" style="height:30px;float:right;text-align:right;overflow:hidden;position:fixed;bottom:0;right:0;color:#000;line-height:30px;cursor:pointer;">
    <div style="background:#232323;color:#FFF;padding:0 6px;float:right;line-height:30px;font-size:14px"><?php echo number_format(microtime(true)-\iboxs\facade\App::getBeginTime(), 6, '.', '').'s ';?></div>
...
<script type="text/javascript">
    (function(){
        ...
        var cookie   = document.cookie.match(/iboxsphp_show_page_trace=(\d\|\d)/);
        ...
        open.onclick = function(){
            ...
            history[0] = 1;
            document.cookie = 'iboxsphp_show_page_trace='+history.join('|')
        }
