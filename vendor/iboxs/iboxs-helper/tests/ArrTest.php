...
class ArrTest extends TestCase
{
    ...
    {
        $array = Arr::add(['name' => 'iboxsPHP'], 'price', 100);
        $this->assertSame(['name' => 'iboxsPHP', 'price' => 100], $array);
    }
    ...
    {
        list($keys, $values) = Arr::divide(['name' => 'iboxsPHP']);
        $this->assertSame(['name'], $keys);
        $this->assertSame(['iboxsPHP'], $values);
    }
    ...
    {
        $array = ['name' => 'iboxsPHP', 'price' => 100];
        $array = Arr::except($array, ['price']);
        $this->assertSame(['name' => 'iboxsPHP'], $array);
    }
    ...
    {
        $array = ['name' => 'iboxsPHP', 'price' => 100, 'orders' => 10];
    ...
    public function testForget()
    {
        ...
        // Only works on first level keys
        $array = ['i@example.com' => 'Joe', 'i@iboxsphp.com' => 'Jane'];
        Arr::forget($array, 'i@example.com');
        $this->assertSame(['i@iboxsphp.com' => 'Jane'], $array);
        // Does not work for nested keys
